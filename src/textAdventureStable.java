...
public class textAdventureStable {
	...
	public static textAdventureStable game = new textAdventureStable();
	...
	public void startGame() {
		...
		if (playGame.equalsIgnoreCase("no")){
			...
			playerClass = playerInput.nextLine();

			while(!(playerChoice.equalsIgnoreCase("Warlock") || playerChoice.equalsIgnoreCase("Assasin") || playerChoice.equalsIgnoreCase("Swordsman") || playerChoice.equalsIgnoreCase("Scholar") || playerChoice.equalsIgnoreCase("kill"))){
				System.out.println("ERROR 404: NOT FOUND");
				System.out.println("Please retry:");
			...
			if (playerClass.equalsIgnoreCase("kill")){
				game.theEnd();
			}
		...
		if (playerChoice.equalsIgnoreCase("left")){
			...
			if (detection == (true)){
				...
				if (hasKey == (true)){
					...
					creatureNames[1] = playerInput.nextLine();
			...
			/*if (playerChoice.equalsIgnoreCase ("cold")){
				...
				creatureNames[2] = playerInput.nextLine();
	...
	public void goLeft(){
		...
		if (goneLeft == (false)){
			...
			System.out.println("1. Yes");
			System.out.println("2. No");
			playerChoice = playerInput2.nextLine();
	...
	public void choosePath(){
		Scanner playerInput3 = new Scanner(System.in);
		...
		if (goneLeft == (false)){
			...
			System.out.println("2. Right");
			System.out.println("3. left");
			playerChoice = playerInput3.nextLine();
			...
			System.out.println("You look at the three paths, one shut by a landslide.");
			game.cont();
			System.out.println("Which way do you wish to continue?");
			//System.out.println("1. Straight");
	...
	public void choosePath2(){
		Scanner playerInput4 = new Scanner(System.in);

		System.out.println("Do you wish to go:");
		System.out.println("1. hot");
		System.out.println("2. cold");

		playerChoice = playerInput4.nextLine();
	...
	public void goHot(){
		...
		Scanner playerInput5 = new Scanner(System.in);
		...
		if (goneHot == (false)){
			...
			playerChoice = playerInput5.nextLine();
	...
	public void goCold(){
		...
		String doorChoice ="";
		Scanner playerInput6 = new Scanner(System.in);
		...
		System.out.println("You go to inspect the remains of the creature. It has kept its rocky outsides, even though you were able to damage it.");
		System.out.println("What do you call this creature?");
		creatureNames[2] = playerInput6.nextLine();
		System.out.println("With the creature you know call a " + creatureNames[2] + " dead, you look around again.");
		System.out.println("You see three large doors, and the right one which has a small, diamond shape.");
		game.cont();
		System.out.println("The left one has a shape that looks similar to the outline of a sword.");
